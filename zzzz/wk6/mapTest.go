...
func main() {
	...
	obj := Demo{"ZZZZZ", 12}
	obj.BBB()
	fmt.Println(obj.addY10())

	xxx := []string{"1", "1", "1", "1", "1"}
	obj2 := Demo2{xxx, 12}
	fmt.Println(obj2.addY5())
	// obj := Demo{"ZZZZZ", 12}
	// obj.AAA()
	// SetDemoName(obj)
...
// AAA 這是番宣
func (d *Demo2) addY5() []string {
	return append(d.NameArray, "123")
}

// AAA 這是番宣
func (d *Demo) addY10() int {
	return d.Age + 10
}

// BBB sss
func (d *Demo) BBB() string {
	return "I'm " + d.Name
}
